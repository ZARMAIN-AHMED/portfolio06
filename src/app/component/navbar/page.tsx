...
<header className="text-white body-font">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center ">
      <Link target='_blank '  href={''} className="mr-5 hover:text-orange-500 text-2xl font-bold leading-relaxed">Home</Link>
    ...
    <a href='/myCV.pdf'>
    <button className="inline-flex items-center bg-orange-500 border-0 py-1 px-3 focus:outline-none hover:bg-amber-600 rounded text-base mt-4 md:mt-0">
